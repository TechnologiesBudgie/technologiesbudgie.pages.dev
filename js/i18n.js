...
const TRANSLATIONS = {
  en: {
    ...
    'what.sub':'From selling refurbished hardware to building cloud-scale software — Technologies Budgie covers the entire technology lifecycle for individuals and enterprises alike.',
    ...
    'card2.title':'Refurbished Hardware','card2.body':'Quality refurbished hardware for consumers and businesses. We source, test, and sell reliable pre-owned machines — and are building our own hardware products.',
    ...
    'footer.all-services':'All Services','footer.repair':'Refurbished Hardware','footer.support':'Enterprise Support','footer.consulting':'Consulting',
    ...
    'marquee.enterprise':'Enterprise Software','marquee.opensource':'Open Source','marquee.repair':'Refurbished Hardware','marquee.systems':'Systems Tooling','marquee.crossplat':'Cross-Platform Apps','marquee.cloud':'Cloud Infrastructure','marquee.devtools':'Developer Tools',
    ...
    'about.mission.p2':'Our approach spans the entire technology stack: from selling quality refurbished hardware, to building systems-level utilities, to delivering enterprise-grade software suites. Eventually, cloud. We move deliberately, ship quality, and keep our code open whenever possible.',
    ...
    'about.timeline2.date':'2025 — Q1/Q2','about.timeline2.title':'Expanding the Suite','about.timeline2.body':'LogDock and Forge Suite development in progress. Refurbished hardware sales launch. Initial enterprise support contracts open with select partners.',
    'about.timeline3.date':'2025 — Q3/Q4','about.timeline3.title':'Hardware & Scale','about.timeline3.body':'Proprietary hardware products announced. Geographic expansion of refurbished hardware sales. LogDock and Forge Suite reach general availability.',
    ...
    'spec.license':'License','spec.type':'Type','spec.foss':'FOSS','spec.partitioning':'Partitioning','spec.gpt_mbr':'GPT + MBR','spec.platform':'Platform','spec.gnu_linux':'GNU/Linux',
    'spec.audience':'Audience','spec.pers_prof':'Personal + Professional','spec.linux_more':'Linux-first · More planned','spec.status':'Status','spec.design_dev':'Design & Development',
    'spec.pers_comm':'Personal + Community','spec.early_design':'Early Design Phase','spec.pers_teams':'Personal + Teams',
    ...
    'products.ldce.tagline':'Community Edition — Structured log viewer',
    'products.ldce.body':'The community-driven, open-source version of LogDock. Focused on local log file management, real-time tailing, and essential filtering for developers and power users. Built for the community, by the community.',
    'products.ldce.cta1':'Join Waitlist','products.ldce.badge':'In Development','products.ldce.cta.source':'View Source on Codeberg',
    ...
    'services.hw.label':'Hardware Services','services.hw.title':'Refurbished Hardware','services.hw.sub':'Quality refurbished hardware for consumers and businesses. We source, test, and certify pre-owned machines so you get reliable gear at the right price.',
    'services.repair.title':'Refurbished Hardware','services.repair.body':'Sourced, tested, and certified pre-owned laptops, desktops, and workstations — for individuals and businesses alike. Every unit goes through rigorous quality checks before sale.',
    'services.repair.f1':'Laptops &amp; desktops available','services.repair.f2':'Workstations &amp; servers','services.repair.f3':'Full hardware inspection &amp; testing','services.repair.f4':'Warranty included on every unit',
    ...
    'services.cta.title':'Ready to get started?','services.cta.sub':'Reach out and tell us about your project or hardware needs. We\'ll get back to you as soon as we can.','services.cta.btn':'Contact Us',
    // Contact
    'contact.hero.label':'Get In Touch','contact.hero.title':'Let\'s build','contact.hero.title2':'something together.',
    'contact.hero.sub':'Have a project in mind, interested in refurbished hardware, or want to learn more? We do our best to respond to every inquiry as quickly as possible.',
    ...
    'contact.form.opt1':'Refurbished Hardware','contact.form.opt2':'Enterprise Software','contact.form.opt3':'Open Source / Products',
    ...
    'preorder.form.opt2ce':'LogDock CE (in development)',
    'preorder.form.opt3':'Forge Suite (in development)','preorder.form.opt4':'Refurbished Hardware',
  ...
  fr: {
    ...
    'what.sub':'De la vente de matériel remis à neuf au développement de logiciels à grande échelle — Technologies Budgie couvre l\'ensemble du cycle de vie technologique pour les particuliers et les entreprises.',
    ...
    'card2.title':'Matériel reconditionné','card2.body':'Matériel reconditionné de qualité pour les particuliers et les entreprises. Nous sourçons, testons et vendons des machines d\'occasion fiables — et développons nos propres produits matériels.',
    ...
    'footer.all-services':'Tous les services','footer.repair':'Matériel reconditionné','footer.support':'Support entreprise','footer.consulting':'Conseil',
    ...
    'marquee.enterprise':'Logiciels d\'entreprise','marquee.opensource':'Open Source','marquee.repair':'Matériel reconditionné','marquee.systems':'Outils systèmes','marquee.crossplat':'Apps multiplateformes','marquee.cloud':'Infrastructure cloud','marquee.devtools':'Outils développeur',
    ...
    'about.mission.p2':'Notre approche couvre l\'ensemble de la pile technologique : de la vente de matériel reconditionné de qualité à la création d\'utilitaires systèmes, en passant par la livraison de suites logicielles de niveau entreprise. Le cloud viendra ensuite. Nous avançons délibérément, livrons de la qualité et gardons notre code ouvert autant que possible.',
    ...
    'about.timeline2.date':'2025 — T1/T2','about.timeline2.title':'Élargissement de la suite','about.timeline2.body':'Développement de LogDock et Forge Suite en cours. Lancement de la vente de matériel reconditionné. Premiers contrats de support entreprise avec des partenaires sélectionnés.',
    'about.timeline3.date':'2025 — T3/T4','about.timeline3.title':'Matériel & Expansion','about.timeline3.body':'Annonce des produits matériels propriétaires. Expansion géographique de la vente de matériel reconditionné. LogDock et Forge Suite en disponibilité générale.',
    ...
    'spec.license':'Licence','spec.type':'Type','spec.foss':'FOSS','spec.partitioning':'Partitionnement','spec.gpt_mbr':'GPT + MBR','spec.platform':'Plateforme','spec.gnu_linux':'GNU/Linux',
    'spec.audience':'Public','spec.pers_prof':'Personnel + Professionnel','spec.linux_more':'Linux en priorité · Plus à venir','spec.status':'Statut','spec.design_dev':'Conception & Développement',
    'spec.pers_comm':'Personnel + Communauté','spec.early_design':'Phase de conception initiale','spec.pers_teams':'Personnel + Équipes',
    ...
    'products.ldce.tagline':'Édition Communautaire — Visualisation de journaux',
    'products.ldce.body':'La version open source et communautaire de LogDock. Concentrée sur la gestion des fichiers journaux locaux, le suivi en temps réel et le filtrage essentiel pour les développeurs et les utilisateurs avancés. Construite pour la communauté, par la communauté.',
    'products.ldce.cta1':'Rejoindre la liste d\'attente','products.ldce.badge':'En développement','products.ldce.cta.source':'Voir le code sur Codeberg',
    ...
    'services.hw.label':'Services matériels','services.hw.title':'Matériel reconditionné','services.hw.sub':'Matériel reconditionné de qualité pour les particuliers et les entreprises. Nous sourçons, testons et certifions des machines d\'occasion pour vous offrir un équipement fiable au bon prix.',
    'services.repair.title':'Matériel reconditionné','services.repair.body':'Ordinateurs portables, fixes et stations de travail reconditionnés, sourcés et certifiés — pour les particuliers et les entreprises. Chaque appareil passe par des contrôles qualité rigoureux avant la vente.',
    'services.repair.f1':'Ordinateurs portables &amp; fixes disponibles','services.repair.f2':'Stations de travail &amp; serveurs','services.repair.f3':'Inspection &amp; tests matériels complets','services.repair.f4':'Garantie incluse sur chaque unité',
    ...
    'services.cta.title':'Prêt à démarrer ?','services.cta.sub':'Contactez-nous pour nous parler de votre projet ou de vos besoins en matériel. Nous vous répondrons dès que possible.','services.cta.btn':'Nous contacter',
    // Contact
    'contact.hero.label':'Nous contacter','contact.hero.title':'Construisons','contact.hero.title2':'quelque chose ensemble.',
    'contact.hero.sub':'Vous avez un projet en tête, un besoin en matériel reconditionné ou souhaitez en savoir plus ? Nous faisons de notre mieux pour répondre à chaque demande le plus rapidement possible.',
    ...
    'contact.form.opt1':'Matériel reconditionné','contact.form.opt2':'Logiciels d\'entreprise','contact.form.opt3':'Open Source / Produits',
    ...
    'preorder.form.opt2ce':'LogDock CE (en développement)',
    'preorder.form.opt3':'Forge Suite (en développement)','preorder.form.opt4':'Matériel reconditionné',
